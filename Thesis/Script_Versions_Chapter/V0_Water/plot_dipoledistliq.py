...
class plot_dipoledistliq(object):
    def __init__(self):
        pass
################################################################################
################################################################################
################################################################################
    def read_data(self,T, p_list):
        csvfile_list = []
        for p in p_list:
...
################################################################################
        ...
        plt.savefig('./Figures/dipole_distliq.pdf')
        plt.savefig('./Figures/dipole_distliq.png')
