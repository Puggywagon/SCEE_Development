...
class plot_dipolestats(object):
################################################################################
################################################################################
################################################################################
    def plot_dipolestats(self):
        ...
        csvfile = './Results/Average_Dipoles.csv'
        lines_csvfile = './Average_Dipoles_lines.csv'
...
################################################################################
        ...
        ax1.text(0.8, 0.1, '(a)', transform=ax1.transAxes, fontsize=fontsize)
...
################################################################################
        ...
        ax2.text(0.8, 0.1, '(b)', transform=ax2.transAxes, fontsize=fontsize)
...
################################################################################
        ...
        plt.savefig('./Figures/dipole_statistics.pdf')
        plt.savefig('./Figures/dipole_statistics.png')
