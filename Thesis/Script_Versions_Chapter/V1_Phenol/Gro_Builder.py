        ...
        for i, atom in enumerate(solmol.GetAtoms()):
            if atom.GetSymbol()=='H':
                if functional_groups=="Ketone":
                    skips +=1
                if functional_groups =="Carboxylic Acid":
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        inputs.append(input_list)
                    else:
                        skips +=1
                if functional_groups =="Ester":
                    skips +=1
                if functional_groups =="Aldehyde":
                    skips +=1
                if functional_groups =="Secondary Amine":
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        ...
                        skips +=1
                if functional_groups =="Tertiary Amine":
                    skips +=1
                if functional_groups =="Primary Amine":
                    if i == len(solmol.GetAtoms()) - 2:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:10s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        inputs.append(input_list)
                    elif i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10    
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:10s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        inputs.append(input_list)
                ...
                if functional_groups =="Thiol":
                    if i == len(solmol.GetAtoms()) - 1:
                        ...
                        skips +=1
                if functional_groups =="Ether":
                    skips +=1
                if functional_groups =="Secondary Alcohol":     
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        ...
                        skips +=1   
                if functional_groups =="Tertiary Alcohol":
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        ...
                        skips +=1
                if functional_groups =="Primary Alcohol":
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        ...
                        skips +=1
                if functional_groups =="Diol":
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        inputs.append(input_list)
                    elif i == len(solmol.GetAtoms()) - 2:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        inputs.append(input_list)
                        ...
                        skips +=1
                if functional_groups =="Amino Acid":
                    if i == len(solmol.GetAtoms()) - 1:
                        pos = (solmol.GetConformer().GetAtomPosition(i))/10
                        symbol=atom.GetSymbol()
                        input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1-skips:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                        ...
                        skips +=1
                if functional_groups =="Carbons only":
                    skips +=1
                if functional_groups =="Aromatic":
                    pos = (solmol.GetConformer().GetAtomPosition(i))/10
                    symbol=atom.GetSymbol()
                    input_list = f"{1:5d}{solresname:5s}{symbol:5s}{i+1:5d}{pos.x:8.3f}{pos.y:8.3f}{pos.z:8.3f}\n"
                    inputs.append(input_list)
            else:
                pos = (solmol.GetConformer().GetAtomPosition(i))/10
                symbol=atom.GetSymbol()
