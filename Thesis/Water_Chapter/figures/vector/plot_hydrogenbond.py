...
#nist_csvfile = '../../data/NIST_vaporpressure.csv'
#tip4p_csvfile = '../../data/TIP4P_vaporpressure.csv'
csvfile = '../../TIP4P_Results/pcm_dipoles.csv'
nist_csvfile = './NIST_vaporpressure.csv'
tip4p_csvfile = './TIP4P_vaporpressure.csv'
...
for T in T_list:    
    ...
    if(tmp['Nearest'].min() < 1.0 and T > Tc):
...
plt.savefig('../hydrogenbond.pdf')
plt.savefig('../hydrogenbond.png')
if (show):
    plt.show()
else:    
    plt.clf()
